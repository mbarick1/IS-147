// This is Exercise 3.11 for Lab Project and my name is MBarick Traore

import java.util.Scanner;

public class MtFindTheNumberOfDaysInMonth
{
   ...
   switch(month)
   {
      ...
      case 6: System.out.println("June " + year + " has 30 days");
              break;
      case 7 :System.out.println("Jully " + year + " has 31 days");
              break;
